...
// ════════════════════════════════════════════════════════════════════
{
  ...
  assert.deepStrictEqual(t['KALI DUTRA'],
    { vendidas: 2, pagas: 1, aguardando: 1, conferir: 0, canceladas: 0, naoComissionado: false });
  assert.deepStrictEqual(t['BÁRBARA VIEIRA CARDOSO'],
    { vendidas: 1, pagas: 0, aguardando: 0, conferir: 1, canceladas: 0, naoComissionado: false });
...
// ════════════════════════════════════════════════════════════════════
{
  ...
  assert.deepStrictEqual(VA.resumo(cruzado),
    { vendidas: 3, pagas: 1, aguardando: 1, conferir: 1, canceladas: 0 });
...
// rodado. Aqui as duas funções são recortadas do index.html e chamadas.
{
  ...
  assert.deepStrictEqual(dela.resumo, { vendidas: 1, pagas: 1, aguardando: 0, conferir: 0, canceladas: 0 },
    'a Kali vê a venda dividida como dela, e não vê a da colega');
  assert.deepStrictEqual(d.resumo, { vendidas: 2, pagas: 1, aguardando: 1, conferir: 0, canceladas: 0 },
...
// se contradizendo.
{
  ...
  assert.deepStrictEqual(VA.resumo(c), { vendidas: 2, pagas: 0, aguardando: 2, conferir: 0, canceladas: 0 });
