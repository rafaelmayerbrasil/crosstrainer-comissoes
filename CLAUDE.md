...
> **🟡 FRENTE VIVA — COMISSÕES: JULHO CALCULADO EM R$ 3.381,30 (15/08/2026), falta aplicar as 8 divisões na tela.** As planilhas corrigidas (`carga nova comissoes/CORRIGIDO-julho-2026-{CP,PP}.xlsx`) já foram subidas; as divisões não mudam o total, só a distribuição. **⚠️ Antes de pagar:** confirmar se **"mais de 10 ativações"** para o rateio do P3 é 10 ou 11 — hoje a Kali leva sozinha R$ 258,31 e a Francini fica de fora por **uma** ativação. Julho fechou cruzando os relatórios do TecnoFit (vendedor correto) com o export da Pacto (o que foi pago), mais **14 vendas que só existem na Pacto** — a última semana de julho foi vendida direto lá. **🧭 Rumo:** depois de julho, **avaliar a API da Pacto** em vez de construir adaptador de Excel (o spec `docs/superpowers/specs/2026-08-14-adaptador-pacto-comissoes-design.md` está PARADO, fora do git, de propósito). **Leia `memory/migracao-relatorio-pacto-comissoes.md` antes de tocar em qualquer coisa** — tem as regras confirmadas pelo Rodrigo, as armadilhas que já morderam e as 6 pendências. Detalhe: `CONTEXTO_SESSAO.md` → sessão 51. Memórias: [[migracao-relatorio-pacto-comissoes]] · [[pacto-api-integracao]] · [[comissao-entrada-atrasada]].
>
